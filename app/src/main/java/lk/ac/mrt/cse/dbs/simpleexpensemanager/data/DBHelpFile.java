...
public class DBHelpFile extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "170406P";
...
//    create keys
    ...
    public static DBHelpFile instance;

    public static DBHelpFile getInstance(Context context) {
        if (instance == null) {
            instance = new DBHelpFile(context);
        }
        return instance;
    };
    ...
    public DBHelpFile(@Nullable Context context) {
